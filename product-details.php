...
<section class="s-product-details l-block--margin">
...
<section class="s-product-description l-block--margin js-block-with-tabs">
	...
	<div class="tab-block l-block">
		<table>
			...
			<tr>
				<td>Область персонализации аверс, мм</td>
				<td>25 мм</td>
				<td>25 мм</td>
				<td>25 мм</td>
			</tr>
			<tr>
				<td>Область персонализации реверс, мм</td>
				<td>42 мм</td>
				<td>42 мм</td>
				<td>42 мм</td>
			</tr>
	...
	<div class="tab-block l-block">
		<div class="row">
			...
			<div class="grid-4 grid-12_s">
				<img src="img/products/prod-descr-img.jpg" alt="1">
				<p class="img-descr">Подпись под картинкой, возможно со ссылкой. Например: <a href="#">комплектация кубков</a></p>
			</div>
		</div>
	</div>
...
<section class="s-show-more l-block--margin">
...
<section class="l-block l-block--margin s-callback">
	...
	<p>Свяжитесь с нами по телефону <nobr><strong><a href="tel:8 800 500-73-89">8 800 500-73-89</a></strong></nobr><br>или оставьте заявку и мы вам перезвоним.</p>
